...
public class Options {
	...
	private PlayerSettings getDefaultPlayerSettings(int playerNumber){
		switch(playerNumber){
		case 1: return new PlayerSettings(Keys.W,Keys.S,Keys.A,Keys.D,Keys.Q,Keys.E, new Fireball(1), new Fireball(1), "Player1");
		
		case 2: return new PlayerSettings(Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN, new Fireball(2), new Fireball(2), "Player2");
			
		case 3: return new PlayerSettings(Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN, new Fireball(3), new Fireball(3), "Player3");
			
		case 4: return new PlayerSettings(Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN,Keys.UNKNOWN, new Fireball(4), new Fireball(4), "Player4");
