...
/**
 * 
 * This class collects information from a tmx file (the game map)
 * and creates bodies out of all the objects in the map
 * For example the lava, the ground, etc. 
 * 
 * 
 * 
 * 
...
//		}
	...
	public void createPhysics(Map map, String layerName) {
		...
		while(objectIt.hasNext()) {
			...
			fixtureDef.filter.categoryBits = edu.chl.KeyboardChaos.util.KCConstants.BIT_LAVA;
			fixtureDef.filter.maskBits = edu.chl.KeyboardChaos.util.KCConstants.BIT_PLAYER;
